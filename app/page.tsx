        ...
        <div className="container px-5 py-12 mx-auto">
          ...
          <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
            ...
            <p className="leading-relaxed text-xl text-justify  max-sm:text-lg">
              Hello there! I&apos;m currently a final year student pursuing my
              B.Tech degree from VIT-Bhopal University. As a passionate MERN
              developer with specialized skills in Next.js and Tailwind, I bring
              a blend of academic excellence and real-world experience to the
              table. With professional internship stints in corporate settings,
              I&apos;ve honed my skills and gained invaluable insights into the
              industry. I&apos;ve also dedicated significant time to hands-on
              projects, shaping my ability to translate ideas into functional,
              user-centric websites. I thrive on the thrill of learning and am
              constantly seeking opportunities to push boundaries and create
              dynamic online experiences. Let&apos;s connect and bring your
